...
function InfoTooltip({ text }: { text: string }) {
  ...
  return (
    <span
      ...
      style={{ position: "relative", display: "inline-flex", alignItems: "center", marginLeft: "8px", cursor: "help", verticalAlign: "middle" }}
    >
      <svg
        ...
        onMouseEnter={(e) => (e.currentTarget.style.stroke = "var(--brand)")}
        onMouseLeave={(e) => (e.currentTarget.style.stroke = "var(--text-tertiary)")}
      >
      ...
      <main className="container" style={{ paddingTop: '64px', minHeight: '80vh', paddingBottom: '64px' }}>
        ...
        <div style={{ marginBottom: '80px', paddingBottom: '64px', borderBottom: '1px solid var(--border)' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '40px' }}>
            <h2 style={{ fontSize: '28px', fontWeight: 600, color: 'var(--text-primary)', display: 'flex', alignItems: 'center' }}>
              Deep-Dive Ticker Analytics
              <InfoTooltip text="Select any S&P 500 ticker from the dropdown to explore its historical Risk & Return performance alongside momentum oscillators (RSI and MACD). All charts use the last 40 trading days of data, giving you a focused, recent view of price behavior." />
            </h2>
            ...
            <div style={{ display: "grid", gridTemplateColumns: 'repeat(auto-fit, minmax(600px, 1fr))', gap: "48px" }}>
              ...
              >
                <h2 style={{ fontSize: "20px", fontWeight: 600, marginBottom: "24px", display: 'flex', alignItems: 'center' }}>
                  ...
                  <InfoTooltip text="The top chart overlays two metrics: Daily Return % (left axis, blue line) shows how much the stock moved each day  positive means it gained, negative means it fell. Volatility (right axis, orange) is the 30-day rolling standard deviation of those returns  a higher value means the stock has been swinging more wildly. When volatility spikes but returns stay flat, that's often a sign of market uncertainty." />
                </h2>
                ...
                <div style={{ height: 250 }}>
                  <h3 style={{ fontSize: "14px", fontWeight: 500, color: "var(--text-secondary)", marginBottom: "16px", textAlign: "center", display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    Daily Returns Distribution (Full History)
                    <InfoTooltip text="This histogram shows how often the stock produced each return over its full available history. A tall bar near 0% means the stock had many flat days (low volatility). Wide bars spread toward +3% or -3% indicate high-volatility behavior. A distribution that skews right (taller bars on positive side) suggests a historically bullish stock." />
                  </h3>
                  <ResponsiveContainer width="100%" height="100%">
              ...
              >
                <h2 style={{ fontSize: "20px", fontWeight: 600, marginBottom: "24px", display: 'flex', alignItems: 'center' }}>
                  ...
                  <InfoTooltip text="This dashboard contains two momentum indicators traders use to time entries and exits. RSI (top) measures how overbought or oversold a stock is on a 0–100 scale. MACD (bottom) measures the momentum of trend changes by comparing two moving averages. Together, they can confirm or contradict each other  e.g. an RSI above 70 with a MACD turning negative can signal a coming pullback." />
                </h2>
                ...
                <div style={{ height: 250, marginBottom: "32px" }}>
                  <h3 style={{ fontSize: "14px", fontWeight: 500, color: "var(--text-secondary)", marginBottom: "16px", textAlign: "center", display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <InfoTooltip text="RSI-14 compares average gains vs. average losses over the last 14 trading days, producing a 0–100 score. Above 70 (red zone): the stock has risen too fast and may pull back  watch for a reversal or slow down buying. Below 30 (green zone): the stock may have been oversold and could bounce  a potential entry signal. Between 30–70: neutral momentum with no strong signal either way." />
                  </h3>
                  <ResponsiveContainer width="100%" height="100%">
                ...
                <div style={{ height: 250 }}>
                  <h3 style={{ fontSize: "14px", fontWeight: 500, color: "var(--text-secondary)", marginBottom: "16px", textAlign: "center", display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <InfoTooltip text="MACD compares two exponential moving averages (12-day vs. 26-day). The blue MACD Line minus the red Signal Line (9-day EMA of MACD) gives the histogram bars. Blue bars above 0 = bullish momentum. Red bars below 0 = bearish momentum. A crossover (MACD line crossing above the signal line) is a classic buy signal; crossing below is a sell signal." />
                  </h3>
                  <ResponsiveContainer width="100%" height="100%">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '24px' }}>
          ...
          <div style={{ background: 'var(--bg-2)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: '24px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', flexWrap: 'wrap', gap: '16px' }}>
              <h2 style={{ fontSize: '20px', fontWeight: 600, display: 'flex', alignItems: 'center' }}>Sector Performance Ranking<InfoTooltip text="This table ranks all 11 GICS sectors of the S&P 500 by their average daily return  the mean of every constituent stock's daily price change within that sector. A positive return means the sector gained on average today; negative means it lost. Click any sector row to expand it and see which individual stocks belong to it. Click the column header to reverse the sort order." /></h2>
          ...
          <div style={{ background: 'var(--bg-2)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: '24px', display: 'flex', flexDirection: 'column' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr auto 1fr', alignItems: 'center', marginBottom: '24px', gap: '16px' }}>
              <div>
                <h2 style={{ fontSize: '20px', fontWeight: 600, display: 'flex', alignItems: 'center' }}>Ticker Rankings<InfoTooltip text="Switch between two ranking modes. RSI Mode ranks all S&P 500 tickers by their current 14-day RSI  highest at the top means most overbought, lowest means most oversold. Volatility Mode ranks by 30-day rolling standard deviation of daily returns  higher means the stock has been swinging more. Use RSI to find momentum extremes; use Volatility to identify risk levels before entering a position." /></h2>
              </div>
